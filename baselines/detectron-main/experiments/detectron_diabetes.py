...
parser.add_argument('--run_name', default="diabetes_lenet", type=str, help='Name of the run, data will be stored in results/args.run_name')
parser.add_argument('--seeds', type=int, default=25, help='Number of seeds to run')
...
p_train, p_val, p_test_all = sample_data.diabetes(split='all')
